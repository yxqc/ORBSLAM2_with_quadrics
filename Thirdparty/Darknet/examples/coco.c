...
void train_coco(char *cfgfile, char *weightfile)
{
    ...
    list_darknet *plist = get_paths(train_images);
    //int N = plist->size;
...
void validate_coco(char *cfg, char *weights)
{
    ...
    char *base = "results/";
    list_darknet *plist = get_paths("data/coco_val_5k.list");
...
void validate_coco_recall(char *cfgfile, char *weightfile)
{
    ...
    list_darknet *plist = get_paths("/home/pjreddie/data/voc/test/2007_test.txt");
    char **paths = (char **)list_to_array(plist);
