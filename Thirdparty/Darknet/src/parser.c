...
list_darknet *read_cfg(char *filename);
...
local_layer parse_local(list_darknet *options, size_params params)
{
...
layer parse_deconvolutional(list_darknet *options, size_params params)
{
    int n = option_find_int(options, "filters",1);
    int size = option_find_int(options, "size",1);
    int stride = option_find_int(options, "stride",1);
...
convolutional_layer parse_convolutional(list_darknet *options, size_params params)
{
    int n = option_find_int(options, "filters",1);
    int size = option_find_int(options, "size",1);
    int stride = option_find_int(options, "stride",1);
...
layer parse_crnn(list_darknet *options, size_params params)
{
...
layer parse_rnn(list_darknet *options, size_params params)
{
...
layer parse_gru(list_darknet *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_lstm(list_darknet *options, size_params params)
{
    int output = option_find_int(options, "output", 1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_connected(list_darknet *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    char *activation_s = option_find_str(options, "activation", "logistic");
    ACTIVATION activation = get_activation(activation_s);
...
layer parse_softmax(list_darknet *options, size_params params)
{
    int groups = option_find_int_quiet(options, "groups",1);
...
layer parse_yolo(list_darknet *options, size_params params)
{
...
layer parse_iseg(list_darknet *options, size_params params)
{
    int classes = option_find_int(options, "classes", 20);
...
layer parse_region(list_darknet *options, size_params params)
{
...
detection_layer parse_detection(list_darknet *options, size_params params)
{
...
cost_layer parse_cost(list_darknet *options, size_params params)
{
...
crop_layer parse_crop(list_darknet *options, size_params params)
{
...
layer parse_reorg(list_darknet *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
maxpool_layer parse_maxpool(list_darknet *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
avgpool_layer parse_avgpool(list_darknet *options, size_params params)
{
    int batch,w,h,c;
    w = params.w;
    h = params.h;
...
dropout_layer parse_dropout(list_darknet *options, size_params params)
{
...
layer parse_normalization(list_darknet *options, size_params params)
{
...
layer parse_batchnorm(list_darknet *options, size_params params)
{
    layer l = make_batchnorm_layer(params.batch, params.w, params.h, params.c);
    return l;
}

layer parse_shortcut(list_darknet *options, size_params params, network *net)
{
...
layer parse_l2norm(list_darknet *options, size_params params)
{
...
layer parse_logistic(list_darknet *options, size_params params)
{
...
layer parse_activation(list_darknet *options, size_params params)
{
    char *activation_s = option_find_str(options, "activation", "linear");
    ACTIVATION activation = get_activation(activation_s);
...
layer parse_upsample(list_darknet *options, size_params params, network *net)
{
...
route_layer parse_route(list_darknet *options, size_params params, network *net)
{
...
void parse_net_options(list_darknet *options, network *net)
{
...
{
    list_darknet *sections = read_cfg(filename);
    ...
    list_darknet *options = s->options;
